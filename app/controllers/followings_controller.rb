class FollowingsController < ApplicationController
  ...
  def create
    @following = helpers.current_user.following_relationships.build(followed_id: params[:id])
  ...
  def set_following
    @following = helpers.current_user.following_relationships.find_by(followed_id: params[:id])
  end
end
